    ...
    <div class="py-12 bg-gray-100 min-h-screen dark:bg-gray-950">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            @php
                ...
                $hasGroupAccess = auth()->check() && ($isAdmin || $group->users->contains(auth()->id()));
                $canManageGroup = $isAdmin || $group->owner_id === auth()->id();
            @endphp
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                        ...
                        @else
                            <div class="mt-6 rounded-xl bg-indigo-50 p-4 text-sm leading-6 text-indigo-900 dark:bg-indigo-950 dark:text-indigo-200">
                                Zaloguj sie i dolacz do grupy, aby dodawac czlonkow oraz nowe wydatki.
                            </div>
                        @endif
                    </div>
                ...
                <div class="space-y-6 lg:col-span-2">
                    ...
                    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <form action="{{ route('groups.show', $group) }}" method="GET" class="mt-5 grid gap-4 md:grid-cols-6">
                            <div class="md:col-span-2">
                            ...
                            <div>
                                <label for="date_from" class="text-sm font-bold text-gray-700 dark:text-gray-200">Od daty</label>
                                <input id="date_from" type="date" name="date_from" value="{{ $filters['date_from'] ?? '' }}" class="mt-1 w-full rounded-xl border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100">
                            </div>
                            <div>
                                <label for="date_to" class="text-sm font-bold text-gray-700 dark:text-gray-200">Do daty</label>
                                <input id="date_to" type="date" name="date_to" value="{{ $filters['date_to'] ?? '' }}" class="mt-1 w-full rounded-xl border-gray-300 bg-white text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-100">
                            </div>
